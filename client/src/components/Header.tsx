  ...
  return (
    <div className="bg-white border-b border-slate-200 p-4 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4">
        {/* PC用のタスク追加ボタン - モバイル時は非表示 */}
        <button 
          className="hidden md:flex items-center bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-md font-medium shadow-sm transition-colors"
